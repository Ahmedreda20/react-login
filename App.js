...
import { StyleSheet, Text, View, CheckBox, TouchableOpacity, Linking , Modal , Pressable } from "react-native";
  ...
  return (
      ...
      >
        ...
        >
          ...
          <Input title="E-mail address" secure={false} correct={false} complete={true} value={setEmail} />
        </View>
        <View
          style={{
            marginVertical: 5,
        ...
        >
          ...
          <View style={{
            ...
            <Input title="Password" secure={secure} correct={false} complete={false} value={setPassword}  />
            ...
            onPress={handleCheck}
            >
              <Feather name={secure ? 'eye-off' : "eye"} style={{
              color: '#EF4444',
              fontWeight: '700',
              fontSize: 18,
            }}/>
      ...
      >
        <Text style={{
          ...
          Don't have an account? <Text style={{
            color: "#EF4444"
          }} onPress={() => Linking.openURL('')}>Sign up</Text>
        </Text>
      </View>
